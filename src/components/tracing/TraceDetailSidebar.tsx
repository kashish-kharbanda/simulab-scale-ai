...
export function TraceDetailSidebar({ open, selectedTrace, onClose }: TraceDetailSidebarProps) {
  ...
  return (
    <div
      className={cn(
        'fixed inset-y-0 right-0 z-50 w-[400px] sm:w-[540px] bg-background border-l shadow-lg transform transition-transform duration-300 ease-in-out overflow-auto',
        open ? 'translate-x-0' : 'translate-x-full',
      )}
    >
      <div className="flex justify-between items-center p-4 border-b">
        <h2 className="font-semibold text-lg">{selectedTrace?.name}</h2>
        ...
        <div className="p-6">
          ...
          <Card>
            <CardContent className="p-4">
              <p className="text-sm font-medium mb-2">Trace Data</p>
